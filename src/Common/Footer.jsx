...
const Footer = () => {
  const navLinks = (
    <>
      <li>
        <NavLink className="px-4 py-1 font-semibold rounded-full text-sm hover:text-primary" to="/">
          Home
        </NavLink>
      </li>
      <li>
        <NavLink className="px-4 py-1 font-semibold rounded-full text-sm hover:text-primary" to="/community">
          Community
        </NavLink>
      </li>
      <li>
        <NavLink className="px-4 py-1 font-semibold rounded-full text-sm hover:text-primary" to="/aboutUs">
          About Us
        </NavLink>
      </li>
      <li>
        <NavLink className="px-4 py-1 font-semibold rounded-full text-sm hover:text-primary" to="/trips">
          Trips
        </NavLink>
      </li>
    </>
